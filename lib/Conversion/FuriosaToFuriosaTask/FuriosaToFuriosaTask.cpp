...
LoadTrfOpLowering::matchAndRewrite(furiosa::LoadTrfOp load_trf_op,
  ...
  { // set sub fetch unit sfr
    ...
    sfr.limits_element3 = dim_b / 32;
    sfr.limits_element4 = dim_a / 32;
    sfr.limits_element5 = 8;
    sfr.limits_element6 = 1;
    sfr.limits_element7 = 1;
    sfr.strides_element0 = 8;
    sfr.strides_element1 = dim_b;
    sfr.strides_element2 = dim_b * 16;
    sfr.strides_element3 = 32;
    sfr.strides_element4 = dim_b * 32;
...
ContractOpLowering::matchAndRewrite(linalg::ContractOp contract_op,
  ...
  { // set main fetch unit sfr
    ...
    sfr.limits_element1 = 2;
    sfr.limits_element2 = 16;
    sfr.limits_element3 = 2;
    sfr.limits_element4 = dim_b / 32;
    sfr.limits_element5 = dim_a / 64;
    sfr.limits_element6 = dim_c / 32;
    sfr.limits_element7 = 1;
    sfr.strides_element0 = dim_c;
    sfr.strides_element1 = 16;
    sfr.strides_element2 = dim_c * 2;
    sfr.strides_element3 = 0;
    sfr.strides_element4 = dim_c * 32;
    sfr.strides_element5 = 0;
    sfr.strides_element6 = 32;
    sfr.strides_element7 = 0;
  ...
  { // set dot product engine sfr
    ...
    sfr.pop_dim = 1;
    sfr.shift_dim = 0;
    sfr.feed_data_type = 2;
    sfr.iter_seq_limits_element0 = 4;
    sfr.iter_seq_limits_element1 = 32;
    sfr.iter_seq_limits_element2 = dim_b / 32;
    ...
    sfr.reg_indexer_strides_element0 = 64;
    sfr.reg_indexer_strides_element1 = 2;
    sfr.reg_indexer_strides_element2 = 256;
    sfr.reg_indexer_strides_element3 = 256 * dim_b / 32;
  ...
  { // set main commit unit sfr
    ...
    sfr.commit_size = 32;
    sfr.limits_element0 = dim_a;
    sfr.limits_element1 = dim_c / 32;
    sfr.limits_element2 = 1;
    sfr.limits_element3 = 1;
    sfr.limits_element4 = 1;
    sfr.limits_element5 = 1;
    sfr.limits_element6 = 1;
    sfr.limits_element7 = 1;
    sfr.strides_element0 = dim_c;
    sfr.strides_element1 = 32;
    sfr.strides_element2 = 0;
    sfr.strides_element3 = 0;
