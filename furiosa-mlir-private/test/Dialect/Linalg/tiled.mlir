...
module {
  module {
    func.func @kernel(%arg0: tensor<64x64x64xf32>, %arg1: tensor<64x64x128xf32>, %arg2: tensor<64x128x64xf32>) -> tensor<64x64x64xf32> attributes {target = #furiosa.target<npu 0 pe 0 : 0>} {
      ...
      %1 = scf.forall (%arg3) in (64) shared_outs(%arg4 = %0) -> (tensor<64x64x128xf32>) {
        ...
        %extracted_slice_0 = tensor.extract_slice %arg1[%arg3, 0, 0] [1, 64, 128] [1, 1, 1] : tensor<64x64x128xf32> to tensor<1x64x128xf32>
        %extracted_slice_1 = tensor.extract_slice %arg4[%arg3, 0, 0] [1, 64, 128] [1, 1, 1] : tensor<64x64x128xf32> to tensor<1x64x128xf32>
        %4 = linalg.contract indexing_maps = [#map, #map1, #map2] ins(%extracted_slice, %extracted_slice_0 : tensor<1x64x64xf32>, tensor<1x64x128xf32>) outs(%extracted_slice_1 : tensor<1x64x128xf32>) -> tensor<1x64x128xf32>
      ...
      %3 = scf.forall (%arg3) in (64) shared_outs(%arg4 = %2) -> (tensor<64x64x64xf32>) {
        ...
        %extracted_slice_0 = tensor.extract_slice %arg2[%arg3, 0, 0] [1, 128, 64] [1, 1, 1] : tensor<64x128x64xf32> to tensor<1x128x64xf32>
        %extracted_slice_1 = tensor.extract_slice %arg4[%arg3, 0, 0] [1, 64, 64] [1, 1, 1] : tensor<64x64x64xf32> to tensor<1x64x64xf32>
        %4 = linalg.contract indexing_maps = [#map, #map1, #map2] ins(%extracted_slice, %extracted_slice_0 : tensor<1x64x128xf32>, tensor<1x128x64xf32>) outs(%extracted_slice_1 : tensor<1x64x64xf32>) -> tensor<1x64x64xf32>
        scf.forall.in_parallel {
    ...
    func.func @main() {
      ...
      %1 = tensor.empty() : tensor<64x64x128xf32>
      %2 = tensor.empty() : tensor<64x128x64xf32>
      %3 = call @kernel(%0, %1, %2) {target = #furiosa.target<npu 0 pe 0 : 0>} : (tensor<64x64x64xf32>, tensor<64x64x128xf32>, tensor<64x128x64xf32>) -> tensor<64x64x64xf32>
      return
    }
  }
