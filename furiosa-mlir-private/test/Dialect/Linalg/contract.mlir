...
module attributes {transform.with_named_sequence} {
  transform.named_sequence @__transform_main(%arg1: !transform.any_op {transform.readonly}) {
    ...
    %1, %loops:1 = transform.structured.tile_using_forall %0 num_threads [32, 2, 0, 0] { mapping = [ #furiosa.mapping, #furiosa.mapping ] } : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
    transform.yield
  }
}
