module {
  func.func @kernel(%arg0: tensor<256xf32>, %arg1: tensor<256xf32>) -> () attributes { target = #furiosa.target<npu 0 pe 0:1> } {
  ...
  func.func @main() {
    %0 = tensor.empty() { dram_address = 0x10000, operand } : tensor<256xf32>
    %1 = tensor.empty() { dram_address = 0x20000, result } : tensor<256xf32>
