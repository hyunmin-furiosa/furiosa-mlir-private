...
module {
  func.func @kernel(%arg0: tensor<64x64x64xi8>, %arg1: tensor<64x64x64xi8>, %arg2: tensor<64x64x64xi8>) attributes {address_allocated, target = #furiosa.target<npu 0 pe 0 : 0>} {
    %0 = furiosa_task.dma_descriptor source %arg0 : tensor<64x64x64xi8> {destination_base = 268435456 : i64, destination_limits = [1, 64, 1, 1, 1, 64], destination_strides = [64, 64, 4096, 4194304, 4194304, 4194304], indirect = 0 : i64, opcode = 0 : i64, source_limits = [1, 64, 1, 1, 1, 64], source_strides = [64, 64, 4096, 0, 0, 4096]}
    ...
    %3 = furiosa_task.sfr.sub_fetch_unit {flit_count = 128 : i64, limits = [4, 2, 2, 2, 2, 8, 1, 1], strides = [8, 64, 1024, 32, 2048, 128, 0, 0], words_per_packet = 4 : i64}
    ...
    %11 = furiosa_task.dma_descriptor source %arg1 : tensor<64x64x64xi8> {destination_base = 268439552 : i64, destination_limits = [1, 64, 1, 1, 1, 64], destination_strides = [64, 64, 4096, 4194304, 4194304, 4194304], indirect = 0 : i64, opcode = 0 : i64, source_limits = [1, 64, 1, 1, 1, 64], source_strides = [64, 64, 4096, 0, 0, 4096]}
    ...
    %14 = furiosa_task.dma_descriptor source %arg2 : tensor<64x64x64xi8> {destination_base = 268443648 : i64, destination_limits = [1, 64, 1, 1, 1, 64], destination_strides = [64, 64, 4096, 4194304, 4194304, 4194304], indirect = 0 : i64, opcode = 0 : i64, source_limits = [1, 64, 1, 1, 1, 64], source_strides = [64, 64, 4096, 0, 0, 4096]}
    ...
    %17 = furiosa_task.sfr.main_fetch_unit {base = 4096 : i64, fetch_size = 16 : i64, flit_count = 256 : i64, limits = [2, 2, 16, 2, 2, 1, 2, 1], strides = [64, 16, 128, 0, 2048, 0, 32, 0], words_per_packet = 4 : i64}
    %18 = furiosa_task.mtosfr %17  {sfr_address = 16715776 : i64}
    %19 = furiosa_task.sfr.dot_product_engine {acc_cols = 32 : i64, acc_indexer_strides = [1, 0, 0, 0, 0, 0, 0, 0], acc_limit = 32 : i64, data_type = 2 : i64, feed_data_type = 2 : i64, feed_input_transpose = 1 : i64, flits_per_input = 2 : i64, iter_seq_limits = [4, 32, 2, 1, 2, 1, 1, 1], mac_rows = 8 : i64, mac_tree_depth = 1 : i64, mac_type = 1 : i64, pop_dim = 1 : i64, reg_indexer_strides = [64, 2, 256, 512, 0, 0, 0, 0], reg_read_log_size = 1 : i64}
    ...
    %23 = furiosa_task.sfr.main_commit_unit {base = 8192 : i64, commit_in_size = 32 : i64, commit_size = 32 : i64, limits = [64, 2, 1, 1, 1, 1, 1, 1], slice_enable_bitmap_mask = [-1, -1, -1, -1], strides = [64, 32, 0, 0, 0, 0, 0, 0]}
    ...
    %29 = furiosa_task.dma_descriptor destination %arg2 : tensor<64x64x64xi8> {destination_limits = [1, 64, 1, 1, 1, 64], destination_strides = [64, 64, 4096, 0, 0, 4096], indirect = 0 : i64, opcode = 0 : i64, source_base = 268443648 : i64, source_limits = [1, 64, 1, 1, 1, 64], source_strides = [64, 64, 4096, 4194304, 4194304, 4194304]}
  ...
  func.func @main() {
    ...
    %arg0 = furiosa_host.alloc { size = 0x40000, data = [1] }
    %arg1 = furiosa_host.alloc { size = 0x40000, data = [2] }
    %res0 = furiosa_host.alloc { size = 0x40000, data = [0] }
    %pe0 = furiosa_host.pe_program_load_inst %binary { dram_address = 0x0, spm_address = 0x0 }
    %pe1 = furiosa_host.pe_program_launch { spm_address = 0x0, operands = [0x10000, 0x50000, 0x90000] }
    ...
    %hal2 = furiosa_host.hal_program_write_at %arg1 { dram_address = 0x50000 }
    %hal3 = furiosa_host.hal_program_execute %pe
    %hal4 = furiosa_host.hal_program_read_at %res0 { dram_address = 0x90000 }
    %hal = furiosa_host.hal_program_seq %hal0, %hal1, %hal2, %hal3, %hal4
