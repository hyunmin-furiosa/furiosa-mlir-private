...
module {
  func.func @kernel(%arg0: tensor<1x5x3xf32>, %arg1: tensor<1x3x6xf32>, %arg2: tensor<1x6x3xf32>) -> tensor<1x5x3xf32> attributes { target = #furiosa.target<npu 0 pe 0:0> } {
  ...
  func.func @main() {
    ...
    %3 = call @kernel(%0, %1, %2) { target = #furiosa.target<npu 0 pe 0:0> } : (tensor<1x5x3xf32>, tensor<1x3x6xf32>, tensor<1x6x3xf32>) -> tensor<1x5x3xf32>
    return
  }
}
