// RUN: furiosa-mlir-opt -furiosa-allocate-address

#map = affine_map<(d0, d1, d2, d3) -> (d0, d1, d3)>
#map1 = affine_map<(d0, d1, d2, d3) -> (d0, d3, d2)>
#map2 = affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>
module {
  func.func @kernel(%arg0: tensor<64x64x64xf8E5M2>, %arg1: tensor<64x64x64xf8E5M2>, %arg2: tensor<64x64x64xf8E5M2>) attributes {target = #furiosa.target<npu 0 pe 0 : 0>} {
    %0 = furiosa.alloc : tensor<1x64x64xf8E5M2, #furiosa.memory_type<sram>>
    ...
    %1 = furiosa.alloc : tensor<1x64x64xf8E5M2, #furiosa.memory_type<trf>>
    ...
    %4 = linalg.contract indexing_maps = [#map, #map1, #map2] ins(%1, %2 : tensor<1x64x64xf8E5M2, #furiosa.memory_type<trf>>, tensor<1x64x64xf8E5M2, #furiosa.memory_type<sram>>) outs(%3 : tensor<1x64x64xf8E5M2, #furiosa.memory_type<sram>>) -> tensor<1x64x64xf8E5M2, #furiosa.memory_type<sram>>
  ...
  func.func @main() {
    ...
    %2 = furiosa.alloc : tensor<64x64x64xf8E5M2>
