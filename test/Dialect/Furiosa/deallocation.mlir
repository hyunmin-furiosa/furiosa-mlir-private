// RUN: furiosa-mlir-opt -optimize-allocation-liveness
...
module {
  func.func @kernel(%arg0: tensor<64x64x64xf32>, %arg1: tensor<64x64x64xf32>, %arg2: tensor<64x64x64xf32>) attributes {target = #furiosa.target<npu 0 pe 0 : 0>} {
    ...
    furiosa.dealloc %3 : tensor<1x64x64xf32, #furiosa.memory_type<sram>>
    furiosa.dealloc %2 : tensor<1x64x64xf32, #furiosa.memory_type<trf>>
    furiosa.dealloc %1 : tensor<1x64x64xf32, #furiosa.memory_type<sram>>
    furiosa.dealloc %0 : tensor<1x64x64xf32, #furiosa.memory_type<sram>>
    return
  }
  func.func @main() {
    ...
    furiosa.dealloc %2 : tensor<64x64x64xf32>
    furiosa.dealloc %1 : tensor<64x64x64xf32>
    furiosa.dealloc %0 : tensor<64x64x64xf32>
    return
  }
}
